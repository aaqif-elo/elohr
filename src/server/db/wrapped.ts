...
export interface WrappedStats {
    ...
    projectInsights: {
        ...
        projectBreakdown: Array<{ name: string; hours: number; percentage: number }>;
...
function generateBadges(
    ...
    // Marathon worker
    if (stats.timePersonality.longestWorkday && stats.timePersonality.longestWorkday.hours >= 12) {
        badges.push({
            id: "marathon",
...
export async function getWrappedStats(
    ...
    stats.coreStats.totalDaysWorked = workDays.size;
